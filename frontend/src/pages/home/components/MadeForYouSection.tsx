  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  gap-x-5 items-center justify-center">
      {madeForYouSongs.map((song) => {
        ...
        return(
          <div key={song.song_id} className="flex flex-col bg-zinc-800/10 hover:bg-zinc-800/50 rounded-md overflow-hidden max-w-150 justify-center gap-y-1 transition-colors pb-1 group">
